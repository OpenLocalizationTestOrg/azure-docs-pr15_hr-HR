<properties
    pageTitle="Strojne grupe učenje algoritam oglasi lista | Microsoft Azure"
    description="Na ispisivo strojnog učenja algoritam oglasi list pomaže vam odabir desnog algoritam za predvidljivu model u Azure strojnog učenja Studio."
    keywords="Algoritam oglasi list, list oglasi strojnog učenja algoritam"
...
# <a name="machine-learning-algorithm-cheat-sheet-for-microsoft-azure-machine-learning-studio"></a>Strojnog učenja list oglasi algoritam za Microsoft Azure strojnog učenja Studio

**Microsoft Azure strojnog učenja algoritam Cheat list** pomaže u odaberite algoritam desno za model predvidljivu analize.

[Azure strojnog učenja Studio](https://studio.azureml.net/) ima velike biblioteke algoritama iz ***regresije***, ***klasifikacija***, ***Klasteriranje***i linije ***značajkom prepoznavanja*** . Svaki namijenjen je adresa za različite vrste problema strojnog učenja.


## <a name="download-machine-learning-algorithm-cheat-sheet"></a>Preuzimanje: Strojnog učenja algoritam oglasi lista

**Preuzimanje oglasi listu ovdje: [Strojnog učenja algoritam Cheat lista (11 x 17 inča)](http://download.microsoft.com/download/A/6/1/A613E11E-8F9C-424A-B99D-65344785C288/microsoft-machine-learning-algorithm-cheat-sheet-v6.pdf)**

![Strojnog učenja algoritam oglasi lista: Saznajte kako odabrati strojnog učenja algoritam.][cheat-sheet]

[cheat-sheet]: ./media/machine-learning-algorithm-cheat-sheet/machine-learning-algorithm-cheat-sheet-small_v_0_6-01.png

Preuzeti i ispisati na računalu učenje algoritam Cheat radni list veličina tabloid jednostavan pristup i pomoć za odabir algoritam.

> [AZURE.NOTE] Potražite u članku [kako odabrati algoritama za Microsoft Azure strojnog učenja](machine-learning-algorithm-choice.md) detaljni vodič za korištenje oglasi list.

## <a name="more-help-with-algorithms"></a>Dodatnu pomoć za algoritama

* Detaljnije rasprave različite vrste strojnog učenja algoritmi, kako se koriste i kako koristiti taj list oglasi za odabir algoritam desnom potražite u članku [kako odabrati algoritama za Microsoft Azure strojnog učenja](machine-learning-algorithm-choice.md).
