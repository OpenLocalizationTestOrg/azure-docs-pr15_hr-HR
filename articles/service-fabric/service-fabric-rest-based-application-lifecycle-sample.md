<properties
   pageTitle="Ogledna životni ciklus utemeljen na OSTALE aplikacije | Microsoft Azure"
   description="Microsoft Azure servisa tkanina uzorka koji prikazuje životni ciklus aplikacije pomoću servisa tkanina OSTALE sučelja."
...
# <a name="rest-based-application-lifecycle-sample"></a>Ogledna životni ciklus utemeljen na OSTALE aplikacije

Ovaj primjer pokazuje životni ciklus aplikacije servisa tkanina kroz pozive REST API-JA. Dodatne informacije o životnom ciklusu aplikacije servisa tkanina potražite u članku [životni ciklus tkanina servisa aplikacija](service-fabric-application-lifecycle.md).

Ovaj primjer izvršava sljedeće:

* Dodjeljuje resurse pohranite uzorka **WordCount 1.0.0** iz WordCount Aplikacijski paket na slici.
* Prikazuje popis vrsta aplikacija, što obuhvaća WordCount 1.0.0.
* Stvara aplikacije WordCount kao **tkanina: / WordCount**.
* Prikazuje popis aplikacije, što obuhvaća tkanina: / WordCount verzija 1.0.0.
* Dodjeljuje resurse u 1.1.0 verzija uzorka WordCount iz **WordCountUpgrade** paketa aplikacije u trgovini slike.
* Prikazuje popis vrsta aplikacija, koji obuhvaća WordCount 1.0.0 i **WordCount 1.1.0**.
* Nadograđuje aplikacije WordCount verziju 1.1.0.
* Prikazuje popis aplikacije, koji obuhvaća WordCount verziju 1.1.0, ali više ne obuhvaća WordCount verzija 1.0.0.
* Brisanje aplikacije WordCount.
* Prikazat će se popis aplikacija, koji više ne obuhvaća tkanina: / WordCount.
* Verzija unprovisions na 1.1.0 WordCount uzorka.
* Prikazuje popis vrsta aplikacija koje uključuju WordCount 1.0.0, ali više ne obuhvaća WordCount 1.1.0.
* Verzija unprovisions na 1.0.0 WordCount uzorka.
* Prikazuje popis vrsta aplikacija, koji više ne obuhvaća WordCount.


## <a name="prerequisites"></a>Preduvjeti

Ovaj primjer koristi [WordCount uzorka](http://aka.ms/servicefabricsamples) (pronaći u uzorcima **Početak rada** ). Uzorak WordCount moraju biti složeni prvo, a zatim dva paketa aplikacije potrebno je kopirati pohrana slika.

|Mapa|Opis|
|------|-----------|
|WordCount|Primjer aplikacije WordCount. Datoteka **ApplicationManifest.xml** sadrži **ApplicationTypeVersion = "1.0.0"**.|
|WordCountUpgrade|Primjer aplikacije WordCount. Datoteka ApplicationManifest.xml moraju promijeniti kako **ApplicationTypeVersion = "1.1.0"** da biste omogućili nadogradnju aplikacije da se pokreće.|

Za stvaranje paketa aplikacije i kopirajte ih u trgovini sliku, učinite sljedeće:

1. Kopirajte **C:\ServiceFabricSamples\Services\WordCount\WordCount\pkg\Debug** **C:\Temp\WordCount**. Time se stvara Aplikacijski paket WordCount.
2. Kopirajte C:\Temp\WordCount **C:\Temp\WordCountUpgrade**. Time se stvara **WordCountUpgrade aplikacijski** paket.
3. Otvorite **C:\Temp\WordCountUpgrade\ApplicationManifest.xml** u uređivaču teksta.
4. Element **ApplicationManifest** promijeniti atribut **ApplicationTypeVersion** **"1.1.0"**.  Time će se obnoviti broj verzije aplikacije.
5. Spremite datoteku promijenjene ApplicationManifest.xml.
6. Pokrenite sljedeću skriptu komponente PowerShell kao administrator da biste kopirali aplikacije u trgovini slike:
...
Kada se dovrši skriptu PowerShell, ova aplikacija je spreman za pokretanje.

## <a name="example"></a>Primjer

Sljedeći primjer prikazuje životnom ciklusu tkanina servisa aplikacija.
