<properties 
    pageTitle="Početak rada s provjerom autentičnosti certifikat koji se temelji na sustavu iOS | Microsoft Azure" 
    description="Upute za konfiguriranje provjere autentičnosti certifikat koji se temelji na rješenja uz uređaje sa sustavom iOS" 
...
# <a name="get-started-with-certificate-based-authentication-on-ios---public-preview"></a>Početak rada s provjerom autentičnosti certifikat koji se temelji na sustavu iOS – javno pretpregled
...
U ovoj se temi objašnjava konfiguriranje i korištenje certifikat prema provjere autentičnosti (CBA) na uređaju sa sustavom iOS za korisnike od drugih korisnika u tarifama za Office 365 Enterprise, Business i obrazovne ustanove. 
...
| Skype za tvrtke        | dolazim brzo  |


### <a name="requirements"></a>Preduvjeti  

Mora biti verzija uređaj s operacijskim Sustavom iOS 9 i noviji 

Mora biti konfiguriran na vanjskom poslužitelju.  

Za aplikacije sustava Office na iOS potreban je Azure autentikatora.  
...
Kao preporučenim načinom rada, trebali biste ažurirati stranica s pogreškom ADFS sa sljedećim:

- Preduvjeta za instalaciju Azure autentikatora za iOS

- Upute za izdavanje certifikata korisnika. 
...
Na iOS 9 ili novija verzija, podržan je iOS nativni klijent za poštu. Za sve druge aplikacije sustava Exchange ActiveSync, da biste utvrdili ako ta značajka bude podržana, obratite se vaš razvojni inženjer.  
...
1.  Na uređaju probno instalirajte mobilnih aplikacija sustava Office (npr. OneDrive) iz trgovine aplikacija.
...
### <a name="testing-eas-client-applications-on-ios"></a>Testiranje EAS klijentske aplikacije na iOS 

Da biste testirali provjera autentičnosti potvrda aplikacijom nativni pošta na iOS 9 ili noviji: 

1.  Konfiguriranje profila programa EAS koji zadovoljava uvjete iznad. 

2.  Instalacija profila na uređaju sa sustavom iOS (ili pomoću MDM, kao što je Intune ili aplikacije Apple Konfiguratora)

3.  Kada profil pravilno instalirana, otvorite matičnoj aplikaciji pošta, a zatim provjerite je li sinkroniziranje pošte
