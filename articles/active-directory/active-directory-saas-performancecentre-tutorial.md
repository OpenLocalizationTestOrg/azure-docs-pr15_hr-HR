...
Konfiguriranje i testiranje Azure AD jedinstvenu prijavu s PerformanceCentre, morate dovršiti sljedeće sastavni blokovi:
...
2. Na kartici na lijevoj strani kliknite **Razno**, a zatim **Jedinstvenu prijavu**.
