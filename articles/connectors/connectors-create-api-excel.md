<properties
pageTitle="Dodavanje poveznik za Excel | Microsoft Azure"
description="Pregled poveznika programa Excel s parametrima REST API-JA"
services=""    
documentationCenter=""     
authors="msftman"    
manager="erikre"    
...
# <a name="get-started-with-the-excel-connector"></a>Početak rada s poveznik za Excel

Trenutno se ne poveznik za Excel logike aplikacije. 

## <a name="to-use-excel-data"></a>Korištenje podataka programa Excel
Podaci programa Excel možete spremiti kao datoteku vrijednosti odvojenih zarezom (CSV) u mapu za pohranu, kao što je [OneDrive](connectors-create-api-onedrive.md). CSV datoteku možete koristiti i s [poveznik ravnomjerne datoteke](../app-service-logic/app-service-logic-enterprise-integration-flatfile.md).
