<properties
   pageTitle="Elementi jezika SQL Transact u skladištu podataka-SQL | Microsoft Azure"
   description="Popis veza do referentne sadržaje za elemente Transact-SQL jezika koji se koriste za SQL Data Warehouse."
...
# <a name="language-elements"></a>Elementi jezika

## <a name="core-elements"></a>Osnovni elementi

- [Sintaksa konvencije](https://msdn.microsoft.com/library/ms177563.aspx)
- [pravila za imenovanje objekta](https://msdn.microsoft.com/library/ms175874.aspx)
- [rezervirane ključne riječi](https://msdn.microsoft.com/library/ms189822.aspx)
- [uparivanja](https://msdn.microsoft.com/library/ff848763.aspx)
- [Komentari](https://msdn.microsoft.com/library/ms181627.aspx)
- [konstante](https://msdn.microsoft.com/library/ms179899.aspx)
- [vrste podataka](https://msdn.microsoft.com/library/ms187752.aspx)
- [IZVRŠAVANJE](https://msdn.microsoft.com/library/ms188332.aspx)
- [Izrazi](https://msdn.microsoft.com/library/ms190286.aspx)
- [UKLANJANJE](https://msdn.microsoft.com/library/ms173730.aspx)
- [Zaobilazno rješenje svojstvo IDENTITETA](https://msdn.microsoft.com/library/ms186775.aspx)
- [ISPIS](https://msdn.microsoft.com/library/ms176047.aspx)
- [KORIŠTENJE](https://msdn.microsoft.com/library/ms188366.aspx)

## <a name="batches-control-of-flow-and-variables"></a>Serija, kontrola tijek i varijable

- [POČETAK... END](https://msdn.microsoft.com/library/ms190487.aspx)
- [PRIJELOM](https://msdn.microsoft.com/library/ms181271.aspx)
- [DEKLARIRANJE@local_variable](https://msdn.microsoft.com/library/ms188927.aspx)
- [AKO... JOŠ](https://msdn.microsoft.com/library/ms182717.aspx)
...
- [VRATITI](https://msdn.microsoft.com/library/ee677615.aspx)
- [ISPROBAJTE... UHVATITE](https://msdn.microsoft.com/library/ms175976.aspx)
- [VRIJEME](https://msdn.microsoft.com/library/ms178642.aspx)

## <a name="operators"></a>Operatori
- [+ (Dodaj)](https://msdn.microsoft.com/library/ms178565.aspx)
- [+ (Niz Ulančavanje)](https://msdn.microsoft.com/library/ms177561.aspx)
- [-(Minus)](https://msdn.microsoft.com/library/ms189480.aspx)
- [-(Oduzimanje)](https://msdn.microsoft.com/library/ms189518.aspx)
- [* (Množenje)](https://msdn.microsoft.com/library/ms176019.aspx)
- [/ (Dijeljenje)](https://msdn.microsoft.com/library/ms175009.aspx)
- [Modulo](https://msdn.microsoft.com/library/ms190279.aspx)

## <a name="wildcard-characters-to-match"></a>Zamjenski znakovi tako da odgovara
- [= (Jednako)](https://msdn.microsoft.com/library/ms175118.aspx)
- [> (Veće od)](https://msdn.microsoft.com/library/ms178590.aspx)
- [< (Manje od)](https://msdn.microsoft.com/library/ms179873.aspx)
- [> = (odlično od ili jednako)](https://msdn.microsoft.com/library/ms181567.aspx)
- [< = (manje od ili jednako)](https://msdn.microsoft.com/library/ms174978.aspx)
- [<> (Nije jednako)](https://msdn.microsoft.com/library/ms176020.aspx)
- [! = (Nije jednako)](https://msdn.microsoft.com/library/ms190296.aspx)
- [I](https://msdn.microsoft.com/library/ms188372.aspx)
- [IZMEĐU](https://msdn.microsoft.com/library/ms187922.aspx)
- [POSTOJI](https://msdn.microsoft.com/library/ms188336.aspx)
- [U](https://msdn.microsoft.com/library/ms177682.aspx)
- [NIJE [] NULL](https://msdn.microsoft.com/library/ms188795.aspx)
- [KAO ŠTO SU](https://msdn.microsoft.com/library/ms179859.aspx)
- [NE](https://msdn.microsoft.com/library/ms189455.aspx)
- [OR](https://msdn.microsoft.com/library/ms188361.aspx)

### <a name="bitwise-operators"></a>Bitovni operatora

- [& (Bitovni operator AND)](https://msdn.microsoft.com/library/ms174965.aspx)
- [| (Bitovni operator OR)](https://msdn.microsoft.com/library/ms186714.aspx)
- [^ (Bitwise isključivu vrijednost OR)](https://msdn.microsoft.com/library/ms190277.aspx)
- [~ (Bitni nije)](https://msdn.microsoft.com/library/ms173468.aspx)
- [^ = (Bitni isključivo ili jednako)](https://msdn.microsoft.com/library/cc627413.aspx)
- [| = (Jednako je bitovni operator OR)](https://msdn.microsoft.com/library/cc627409.aspx)
- [& = (jednako bitovni operator AND)](https://msdn.microsoft.com/library/cc627427.aspx)
...
- [VELIKIM SLOVOM](https://msdn.microsoft.com/library/ms181765.aspx)
- [PREVLAST i Pretvori](https://msdn.microsoft.com/library/ms187928.aspx)
- [FUNKCIJA CEILING](https://msdn.microsoft.com/library/ms189818.aspx)
- [CHAR](https://msdn.microsoft.com/library/ms187323.aspx)
- [CHARINDEX](https://msdn.microsoft.com/library/ms186323.aspx)
- [KONTROLNI ZBROJ](https://msdn.microsoft.com/library/ms189788.aspx)
- [SPAJANJE](https://msdn.microsoft.com/library/ms190349.aspx)
- [COL_NAME](https://msdn.microsoft.com/library/ms174974.aspx)
- [COLLATIONPROPERTY](https://msdn.microsoft.com/library/ms190305.aspx)
- [SLIKA](https://msdn.microsoft.com/library/hh231515.aspx)
...
- [DAN](https://msdn.microsoft.com/library/ms176052.aspx)
...
- [RAZLIKA](https://msdn.microsoft.com/library/ms188753.aspx)
...
- [KAŠNJENJA](https://msdn.microsoft.com/library/hh231256.aspx)
- [LAST_VALUE](https://msdn.microsoft.com/library/hh231517.aspx)
- [POTENCIJALNI KLIJENT](https://msdn.microsoft.com/library/hh213125.aspx)
- [LIJEVO](https://msdn.microsoft.com/library/ms177601.aspx)
- [LEN](https://msdn.microsoft.com/library/ms190329.aspx)
- [ZAPISNIK](https://msdn.microsoft.com/library/ms190319.aspx)
- [LOG10](https://msdn.microsoft.com/library/ms175121.aspx)
- [LOWER](https://msdn.microsoft.com/library/ms174400.aspx)
- [FUNKCIJE LTRIM](https://msdn.microsoft.com/library/ms177827.aspx)
- [MAX](https://msdn.microsoft.com/library/ms187751.aspx)
- [MIN](https://msdn.microsoft.com/library/ms179916.aspx)
- [MJESEC](https://msdn.microsoft.com/library/ms187813.aspx)
...
- [Skalarne funkcije ODBCS](https://msdn.microsoft.com/library/bb630290.aspx)
- [PUTEM uvjet](https://msdn.microsoft.com/library/ms189461.aspx)
...
- [ZAMJENA](https://msdn.microsoft.com/library/ms186862.aspx)
- [PONAVLJANJA](https://msdn.microsoft.com/library/ms174383.aspx)
- [OBRNUTI](https://msdn.microsoft.com/library/ms180040.aspx)
- [DESNO](https://msdn.microsoft.com/library/ms177532.aspx)
- [ROUND](https://msdn.microsoft.com/library/ms175003.aspx)
- [BROJ_RETKA](https://msdn.microsoft.com/library/ms186734.aspx)
...
- [PRIJAVA](https://msdn.microsoft.com/library/ms188420.aspx)
...
- [SADRŽAJI](https://msdn.microsoft.com/library/ms188043.aspx)
- [PODNIZ](https://msdn.microsoft.com/library/ms187748.aspx)
- [ZBROJ](https://msdn.microsoft.com/library/ms187810.aspx)
...
- [KORISNIK](https://msdn.microsoft.com/library/ms186738.aspx)
- [KORISNIČKO_IME](https://msdn.microsoft.com/library/ms188014.aspx)
- [VAR](https://msdn.microsoft.com/library/ms186290.aspx)
- [VARP](https://msdn.microsoft.com/library/ms188735.aspx)
- [GODINE](https://msdn.microsoft.com/library/ms186313.aspx)
- [XACT_STATE](https://msdn.microsoft.com/library/ms189797.aspx)

## <a name="transactions"></a>Transakcije

- [transakcije](https://msdn.microsoft.com/library/mt204031.aspx)

## <a name="diagnostic-sessions"></a>Dijagnostičke sesije

- [STVARANJE SESIJE DIJAGNOSTIKU](https://msdn.microsoft.com/library/mt204029.aspx)
...
## <a name="set-statements"></a>Postavljanje izvješća

- [POSTAVLJANJE ANSI_DEFAULTS](https://msdn.microsoft.com/library/ms188340.aspx)
- [POSTAVLJANJE ANSI_NULL_DFLT_OFF](https://msdn.microsoft.com/library/ms187356.aspx)
- [POSTAVLJANJE ANSI_NULL_DFLT_ON](https://msdn.microsoft.com/library/ms187375.aspx)
- [POSTAVLJANJE POSTAVKOM](https://msdn.microsoft.com/library/ms188048.aspx)
- [POSTAVLJANJE ANSI_PADDING](https://msdn.microsoft.com/library/ms187403.aspx)
- [POSTAVLJANJE ANSI_WARNINGS](https://msdn.microsoft.com/library/ms190368.aspx)
- [POSTAVLJANJE ARITHABORT](https://msdn.microsoft.com/library/ms190306.aspx)
- [POSTAVLJANJE ARITHIGNORE](https://msdn.microsoft.com/library/ms184341.aspx)
- [POSTAVLJANJE CONCAT_NULL_YIELDS_NULL](https://msdn.microsoft.com/library/ms176056.aspx)
- [POSTAVLJANJE DATEFIRST](https://msdn.microsoft.com/library/ms181598.aspx)
- [POSTAVLJANJE DATEFORMAT](https://msdn.microsoft.com/library/ms189491.aspx)
- [POSTAVLJANJE FMTONLY](https://msdn.microsoft.com/library/ms173839.aspx)
- [POSTAVLJANJE IMPLICIT_TRANSACITONS](https://msdn.microsoft.com/library/ms187807.aspx)
- [POSTAVLJANJE LOCK_TIMEOUT](https://msdn.microsoft.com/library/ms189470.aspx)
- [POSTAVLJANJE NUMBERIC_ROUNDABORT](https://msdn.microsoft.com/library/ms188791.aspx)
- [POSTAVLJANJE QUOTED_IDENTIFIER](https://msdn.microsoft.com/library/ms174393.aspx)
- [BROJ REDAKA ZA POSTAVLJANJE](https://msdn.microsoft.com/library/ms188774.aspx)
- [POSTAVLJANJE TEXTSIZE](https://msdn.microsoft.com/library/ms186238.aspx)
- [POSTAVLJANJE TRANSAKCIJE KAO RAZINU](https://msdn.microsoft.com/library/ms173763.aspx)
- [POSTAVLJANJE XACT_ABORT](https://msdn.microsoft.com/library/ms188792.aspx)
