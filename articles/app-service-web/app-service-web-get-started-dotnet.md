<properties 
    pageTitle="Implementacija prvi .NET web-aplikaciju programa Azure pet minuta | Microsoft Azure" 
...
# <a name="deploy-your-first-net-web-app-to-azure-in-five-minutes"></a>Implementacija prvi .NET web-aplikaciju programa Azure pet minuta

Pomoću ovog praktičnog vodiča pridonosi implementacija jednostavne .NET web-aplikacijama [Aplikacije servisa za Azure](../app-service/app-service-value-prop-what-is.md).
...
- Implementacija uzorak ASP.NET koda.
...
## <a name="deploy-an-net-web-app"></a>Implementacija web-aplikaciju programa .NET
...
1. Promjena radni direktorij (`CD`) i Kloniraj aplikaciju uzorka.
...
4. Stvaranje aplikacije resursa aplikacije servisa u Azure s naziv jedinstveni aplikacije i implementaciju korisnika ste prethodno konfigurirali. Kada se od vas zatraži, navedite broj željeno područje.
    ...
    ![Stvaranje Azure resursa za prvu web-aplikacije u Azure](./media/app-service-web-get-started-languages/dotnet-site-create.png)
...
4. Ogledni kod implementirati Azure aplikacije, kao što činite Gurni kod s brojka. Kada se to od vas zatraži, pomoću lozinke koje ste prethodno konfigurirali.
    ...
    ![Automatske kod na prvi web-aplikaciju u Azure](./media/app-service-web-get-started-languages/dotnet-git-push.png)

    `git push`ne samo stavlja kod u Azure, ali vraća potrebna paketa i sastavlja binarne datoteke ASP.NET. 
...
Saznajte kako stvoriti, razviti i implementacija Azure izravno u Visual Studio pri [uvođenje web-aplikacije programa ASP.NET servisu Azure aplikacije pomoću Visual Studio](web-sites-dotnet-get-started.md).NET web-aplikacije.
