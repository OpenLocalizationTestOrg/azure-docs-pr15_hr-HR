<properties
   pageTitle="Pomoću poveznika servisa Yammer u aplikacijama logike | Aplikacije servisa za Microsoft Azure"
   description="Kako stvoriti i konfigurirati aplikaciju Yammer poveznika ili API-JA i koristiti u aplikaciji logike u aplikacije servisa za Azure"
   services="logic-apps"
...
# <a name="weve-improved-the-yammer-connector"></a>Ne možemo ste poboljšani poveznik za Yammer 
...
- [Dodatne informacije o ovo novi poveznika](../connectors/connectors-create-api-yammer.md)
